...
It supports Market, Limit, Stop-Limit orders, validates CLI input, logs API requests and responses, also separates the REST client from order and command-line logic.
